...
void main() => runApp(MyLocationApp());
...
class MyLocationApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      title: 'LetsFitness Maps',
      theme: ThemeData(
        primarySwatch: Colors.blue,
      ),
      home: MyLocationPage(title: 'LetsFitness',  
      ),
    );
  }
}
...
class _MyLocationPageState extends State<MyLocationPage> {
  ...
  Future<Uint8List> getMarker() async {
    ByteData byteData = await DefaultAssetBundle.of(context).load("assets/steps.png");
